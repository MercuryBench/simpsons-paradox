var makeBlocksCake = function(blockSelection, Nx, Ny, sc, pad, col)
        {
...
var makeBlocksNoRectCake = function(blockSelection, Nx, Ny, sc, pad, col)
    {
        var rectGroup = blockSelection.append("g").attr("id", "rectGroup");
        
    }
var buildGroupCake = function(groupref, data, graphicalData, tooltip_ref, img, noRect=false){
    
    fig = groupref
    fig.append("image").attr("xlink:href", img)
    ...
    blockUL.append("rect")
        ...
        .attr("opacity", 0.5)
    if (noRect == true) {
            makeBlocksNoRectCake(blockUL, data.Nx11, data.Ny1, graphicalData.scale, graphicalData.padding, graphicalData.color[0])
    }
    else
    {    
        makeBlocksCake(blockUL, data.Nx11, data.Ny1, graphicalData.scale, graphicalData.padding, graphicalData.color[0])
    }
    blockUL.append("text")
        .attr("id", "labelU")
    ...
    if (noRect == true)
    {
        makeBlocksNoRectCake(blockUR, data.Nx12, data.Ny1, graphicalData.scale, graphicalData.padding, graphicalData.color[1])
    }
    else
    {
        makeBlocksCake(blockUR, data.Nx12, data.Ny1, graphicalData.scale, graphicalData.padding, graphicalData.color[1])
    }
    blockUR.append("text")
    .attr("id", "labelUR")
    ...
    blockLL.append("rect")
     ...
     if (noRect == true)
    {
        makeBlocksNoRectCake(blockLL, data.Nx21, data.Ny2, graphicalData.scale, graphicalData.padding, graphicalData.color[2])
    }
    else
    {
        makeBlocksCake(blockLL, data.Nx21, data.Ny2, graphicalData.scale, graphicalData.padding, graphicalData.color[2])
    }
    ...
    blockLR.append("rect")
     ...
     if (noRect == true)
    {
        makeBlocksNoRectCake(blockLR, data.Nx22, data.Ny2, graphicalData.scale, graphicalData.padding, graphicalData.color[3])
    }
    else
    {
        makeBlocksCake(blockLR, data.Nx22, data.Ny2, graphicalData.scale, graphicalData.padding, graphicalData.color[3])
    }
    ...
    blockLR.attr('transform', 'translate(' + (data.Nx21*graphicalData.scale) + ',' + (data.Ny1*graphicalData.scale) + ')')
        ...
        if (fig.attr("id") == "groupLeft")
        {
         fig.append("text")
            .attr("id", "labelTop")
            .attr("text-anchor", "middle")
            .attr("transform", `translate(${-graphicalData.paddingBar-graphicalData.heightText}, ${data.Ny1/2*graphicalData.scale})`+ " rotate(270)")
            .text("frosting")
        fig.append("text")
            .attr("id", "labelBottom")
            .attr("text-anchor", "middle")
            .attr("transform", `translate(${-graphicalData.paddingBar-graphicalData.heightText}, ${(data.Ny1+data.Ny2/2)*graphicalData.scale})`+ " rotate(270)")
            .text("batter")
        ...
        else
        {
            ...
            .attr("id", "#labelTop")
                .attr("text-anchor", "middle")
                .attr("transform", `translate(${data.Nx*graphicalData.scale + graphicalData.paddingBar + 1.5*graphicalData.heightText}, ${data.Ny1/2*scale})`+ " rotate(270)")
                .text("frosting")
            fig.append("text")
            .attr("id", "#labelBottom")
                .attr("text-anchor", "middle")
                .attr("transform", `translate(${data.Nx*graphicalData.scale + graphicalData.paddingBar + 1.5*graphicalData.heightText}, ${(data.Ny1+data.Ny2/2)*graphicalData.scale})`+ " rotate(270)")
                .text("batter")
            /*fig.append("text")
                .attr("id", "labelNy")
...
var buildFigureCake = function(reffig, dataLeft, dataRight, graphicalDataLeft, graphicalDataRight, imgLeft, imgRight, noRect=false){
    ...
    var tooltip = reffig.append("g").attr("id", "tooltip")
        .attr("visibility", "hidden")
    var groupLeft = buildGroupCake(reffig.select("#groupLeft"), dataLeft, graphicalDataLeft, tooltip, imgLeft, noRect=noRect)
    var groupRight = buildGroupCake(reffig.select("#groupRight"), dataRight, graphicalDataRight, tooltip, imgRight, noRect=noRect)
    var transformLeftX = parseFloat(graphicalDataLeft.textPadding+graphicalDataLeft.paddingBar+graphicalDataLeft.heightText)
    var transformLeftY = parseFloat(graphicalDataLeft.textPadding+graphicalDataLeft.paddingBar+graphicalDataLeft.titlePadding)
    var transformRightX = parseFloat(groupLeft.attr("width"))+parseFloat(graphicalDataRight.textPadding)+graphicalDataRight.paddingBar+graphicalDataLeft.heightText+graphicalDataRight.heightText
    ...
    var w = parseFloat(groupLeft.attr("width"))+parseFloat(groupRight.attr("width"))+graphicalDataLeft.paddingBlocks + 3*graphicalDataLeft.paddingBar + 2*graphicalDataLeft.heightText; // REVIEW!!!
